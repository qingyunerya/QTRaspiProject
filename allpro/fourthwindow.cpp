...
void FourthWindow:: paintEvent(QPaintEvent *)
{
...
void FourthWindow::ani_timer_tick()
{
  this->update();
}
void FourthWindow::timerUpDate()
{
    adxl345_read_xyz(fd);
    vx[move]=x;
    vy[move]=y;
...
void FourthWindow::adxl345_init(int fd)
{
...
void FourthWindow::adxl345_read_xyz(int fd)
{
...
void FourthWindow::on_read_button_clicked()
{
    if(index==0)
    {
        move=149;
